...
* What does ```chmod +x FILENAME```do?
  - Add a execute permission to a file
...
* What is the difference between a process and a thread? And parent and child processes after a fork system call?
  - A fork it's identical process as the parent but with new PID, it's own memory share, and running independently from the parent, a thread it's a light weight process and usually it's just a CPU state  with the process  containing  the remains. Threads require less overhead then forking or spawning a new process, because doesn't have  a new system virtual memory space and environment.
...
* Describe the linux boot process with as much detail as possible, starting from when the system is powered on and ending when you get a prompt.
  ...
  - User enviroment
    - The typical desktop environment begins with a deamon that calls everything needed.
...
* What is ARP and what is it used for?
  - It's the protocol that maps IP address to MAC address.

* What is the difference between TCP and UDP?
  - TCP it's more reliable but slower, because we are sure that our packets will arrive.

* What is the purpose of a default gateway?
  - The default gateway it's the way to archive other networks.
...
* Can you describe your workflow when you create a script?
  - First I think about the problem, I create some variables, and start to code  trying to use best practices, after a part I test, and so on.

* What is GIT?
  - It's a SCM (source code management), it's a software that controls source code, and helps developers to work together.
...
* What's the relationship between continuous delivery and DevOps?
  - Continous delivery it's inside the DevOps methodology, it's delivery sofware or services fast, without errors,

* What are the important aspects of a system of continuous integration and deployment?
  - testing, automatize the process.
